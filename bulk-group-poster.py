...
def main():
    ...
    account = "khuzaimaqa-1@yopmail.com"
    password = "987654321@aA"

    # Set up Facebook groups to post, you must be a member of the group
    groups_links_list = [
        "https://www.facebook.com/groups/124129414611062/?hoisted_section_header_type=recently_seen&multi_permalinks=1902862053404447", "https://www.facebook.com/groups/sample2"
    ]
    ...
    loginelement = driver.find_element(By.XPATH, "(//button[normalize-space()='Log in'])[1]")
    loginelement.click()
